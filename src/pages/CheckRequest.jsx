                    ...
                    <div id="right">
                        <div id= "right-in">
                            ...
                            <div id="total">
                                ...
                                <button id="pay1"
                                onClick = {() => this.total(this.state.price,this.state.quantity)} >ACCEPT REQUESTS</button>
                                <br/>
                                <button id="pay2"
                                onClick = {() => this.total(this.state.price,this.state.quantity)} >REJECT REQUESTS</button>
